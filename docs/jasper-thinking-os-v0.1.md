...
| 核心问题 | 思考动作 | 可用 Skill |
|---|---|---|
| 问题到底是什么？ | 定义问题、拆解结构、识别假设 | `structured-problem-framing`, `first-principles-reframing` |
